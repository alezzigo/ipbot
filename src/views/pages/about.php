	...
	<div class="section">
		<div class="container small">
			...
			<div class="section">
				...
				<p>Scale any number of your application's dynamic cloud server IPs through a proxy network using <a href="<?php echo $config->settings['base_url']; ?>static-proxies">static HTTP proxy IPs</a>.</p>
