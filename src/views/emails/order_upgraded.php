<?php
	...
	$message .= 'Order Price: ' . number_format($templateParameters['order']['price'], 2, '.', ',') . ' ' . $this->settings['billing']['currency'] . ' increased to ' . number_format($templateParameters['order']['price_pending'], 2, '.', ',') . ' ' . $this->settings['billing']['currency'] . "\n";
