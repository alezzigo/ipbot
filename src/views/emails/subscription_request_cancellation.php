<?php
	$message = 'Hello,' . "\n";
	$message .= "\n";
	$message .= 'This is a confirmation of your recent subscription cancellation request for your recurring subscription at ' . $this->settings['site_name'] . '.' . "\n";
	$message .= "\n";
	...
	$message .= "\n";
	$message .= 'If you\'d like to create a new subscription or reverse this cancellation request, please reply to this email.' . "\n";
	$message .= "\n";
	$message .= '--' . "\n";
