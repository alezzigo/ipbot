<?php
	$message = 'Hello,' . "\n";
	$message .= "\n";
	$message .= 'This is a confirmation for a new recurring subscription created at ' . $this->settings['site_name'] . '.' . "\n";
	$message .= "\n";
	...
	$message .= "\n";
	$message .= 'If you didn\'t create this subscription, or if you\'d like to cancel recurring payments, please reply to this email.' . "\n";
	$message .= "\n";
	$message .= '--' . "\n";
