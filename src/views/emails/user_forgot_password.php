<?php
	...
	$message .= "\n";
	$message .= 'The password reset link above is scheduled to expire in 10 minutes. If you didn\'t request this password reset, please reply to this email immediately.' . "\n";
	$message .= "\n";
	$message .= '--' . "\n";
